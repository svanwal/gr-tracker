...
Revision ID: ee7a7afa4bff
Revises: 
Create Date: 2023-02-03 16:29:10.641895
...
def upgrade():
    ...
    sa.Column('dispname', sa.String(length=30), nullable=False),
    sa.Column('fullname', sa.String(length=150), nullable=False),
    sa.Column('length', sa.Float(), nullable=False),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('dispname'),
    ...
    sa.Column('privacy', sa.Enum('public', 'friends', 'private', name='privacyoption'), nullable=False),
